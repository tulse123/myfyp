...
urlpatterns +=[
    ...
    path('chat_reply', views.chat_reply, name="chat_reply"),
    path('chat_replied', views.chat_replied, name="chat_replied"),
...
urlpatterns +=[
    ...
    path('password_reset_sent', auth_views.PasswordResetDoneView.as_view(template_name="hospital/password_reset_sent.html"), name="password_reset_done"),
    ...
    path('reset_password_complete', auth_views.PasswordResetCompleteView.as_view(template_name="hospital/password_reset_done.html"), name="password_reset_complete"),
